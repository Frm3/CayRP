...
ESX.DrawMarker = function(x,y,z, distInActive, distActive, sX,sY,sZ, text)
	dist = #(GetEntityCoords(PlayerPedId()) - vector3(x,y,z))
	if dist < distInActive then
		DrawMarker(6, x, y, z - 0.95, 0.0 - 90, 0.0 - 90, 0.0 - 90, 0 - 180, 0.0 - 180, 0.0 - 180, sX,sY,sZ, 163, 163, 163, 150, false, true, 2, false, false, false, false)
	end
	if dist <= distActive then
		DrawMarker(6, x, y, z - 0.95, 0.0 - 90, 0.0 - 90, 0.0 - 90, 0 - 180, 0.0 - 180, 0.0 - 180, sX,sY,sZ, 87, 209, 0, 150, false, true, 2, false, false, false, false)
		pisztekst(x, y, z, text)
	end
end

function pisztekst(x,y,z, text)
