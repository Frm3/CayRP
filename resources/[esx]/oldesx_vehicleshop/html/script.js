...
window.addEventListener('message', function(event) {
    ...
    if (event.data.type == "display") {
        ...
        document.getElementById("top-menu").innerHTML = '<a href="#all" onclick="menuVehicle(event)" value="all" class="selected">Wszystkie</a>';       
    ...
    if (event.data.type == "sussess-buy") {
        ...
        <span>Kupiłeś: ` + data.vehicleName + ` za ` + data.value + ` - Rejestracja: ` + data.vehiclePlate + `</span>    
...
function openModalMenu(){    
    ...
    $('#closemenu').append(`
        ...
        <div class="modal-content">
            <p class="title">Potwierdzenie płatności:</p>
    ...
    switch(event.which) {        
        ...
        case 1:
            ...
            if(!itemDisabled) {
                ...
                document.getElementById("vehiclebrand").innerHTML = ' <img id="vehicle_brand_image" src="https://cay-network.pl/cayrp/img/logo.png">';
                ...
                $('#contentVehicle').append(`
                    <div class="handling-container">
                        <span>Specyfikacje pojazdu</span>
                    ...
                    <div class="row spacebetween">
                        <span class="title">V-MAX</span>
                        <span>`+dataCar[4].outerText+` MPH</span>
                    </div>

                    <div class="row spacebetween">
                        <span class="title">Moc</span>
                    ...
                    <div class="row" id="buttonbuy">
                        <button class="buyButton" onclick="openModalMenu()"> Kup </button>
                    </div>
                `);
                
                if (dataCar[7].outerText < 1) {
                    document.getElementById("buttonbuy").innerHTML = '<span class="sold-out-text">WYPRZEDANE</span>';
                }
