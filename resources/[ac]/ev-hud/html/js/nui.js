...
document.querySelector('.accept-button').addEventListener('click', () => {
    ...
    setTimeout(function() {
        alertNoti.textContent = "Ustawienia zostały zapisane!"
...
document.getElementById('reset-color').addEventListener('click', () => {
    ...
    alertNoti.textContent = "Resetuję kolory..."
    setTimeout(function() {
        alertNoti.style.animation = 'none';
        alertNoti.textContent = "Zapisywanie zakończone!"
    }, 1100)
    setTimeout(function() {
...
document.getElementById('reset-position').addEventListener('click', () => {
    ...
    alertNoti.style.display = "flex";
    alertNoti.style.animation = "fadeIn 1s forwards";
    alertNoti.textContent = "Resetuję pozycje..."
    setTimeout(function() {
        alertNoti.style.animation = 'none';
        alertNoti.textContent = "Zapisywanie zakończone!"
    }, 1100)
