...
UTK = {
    ...
    alarmblip,
    text = { -- Texts
        loudstart = "[~r~E~w~] Rozpocznij ~g~GŁOSNY~w~ napad na bank ",
        silentstart = "[~r~E~w~] Rozpocznij ~g~CICHY~w~ napad na bank",
        usecard = "[~r~E~w~] Uzyj karty identyfikacyjnej",
        usethermal = "[~r~E~w~] Uzyj ladunku termicznego",
        usehack = "[~r~E~w~] Panel bezpieczenstwa hakerskiego",
        uselockpick = "[~r~E~w~] Uzyj wytrychów",
        usesearch = "[~r~E~w~] Szukaj",
        lootcash= "[~r~E~w~] Splądruj wózek z pieniędzmi",
        lootgold = "[~r~E~w~] Splądruj wózek z złotem",
        lootdia = "[~r~E~w~] Splądruj wózek z diamentami",
        card = "Korzystanie z karty identyfikacyjnej",
        thermal = "Sadzenie ładunku termicznego",
        burning = "Topienie blokady",
        lockpick = "Otwieranie zamka",
        using = "Przetwarzanie panelu",
        used = "Proces zakończony.",
        stage = "zakończony.",
        search = "Szukanie",
        hacking = "Hacking",
        melted = "Zamek drzwi stopił się.",
        hacked = "Hakowanie zakończone.",
        unlocked = "Drzwi odblokowane.",
        nothing = "Nic nie znaleziono.",
        found = "Znalazłeś kartę dostępu.",
        time = "Pozostały: "
    }
