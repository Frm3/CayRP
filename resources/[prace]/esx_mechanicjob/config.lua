...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -1428.02, y = -458.33, z = 34.91 },
	...
	Garage = {
		Pos   = { x = 1001.5, y = -2317.92, z = 35.32 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -1416.59, y = -464.61, z = 34.47 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -1397.55, y = -462.92, z = 33.2 },
	...
	VehicleDelivery = {
		Pos   = { x = -1000.87, y = -2353.21, z = 30.51 },
