...
Citizen.CreateThread(function()
	while true do
		...
		if ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'ambulance' then
		 exports["rp-radio"]:GivePlayerAccessToFrequencies(1, 2, 3, 4, 5, 6, 7)
		elseif ESX.PlayerData.job ~= nil then
			exports["rp-radio"]:RemovePlayerAccessToFrequencies(1, 2, 3, 4, 5, 6, 7)
		end
	end
end)
...
Citizen.CreateThread(function()
	while true do
		...
		if IsDead then
			...
			EnableControlAction(1, Keys['PAGEUP'], true)
...
RegisterNetEvent('esx_ambulancejob:reviveeq')
AddEventHandler('esx_ambulancejob:reviveeq', function()
	local playerPed = PlayerPedId()
