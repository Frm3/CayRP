...
RegisterNetEvent("crp_antiCL:show")
AddEventHandler("crp_antiCL:show", function()
    if show3DText then
        show3DText = false
    else
        show3DText = true
...
RegisterNetEvent("crp_anticl")
AddEventHandler("crp_anticl", function(id, crds, identifier, reason)
