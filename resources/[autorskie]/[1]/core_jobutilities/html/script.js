...
'        <p><span id="u746">'+employees[i].name+' '+employees[i].surname+'</span></p>'+
'       </div>'+
...
'        <p id="inputtext">WPROWADŹ BONUS</p>'+
...
'        <p id="inputtext">JESTEŚ PEWNY?</p>'+
'        <p id="inputothertext">Chcesz zwolnić z pracy ' +$(t).parent().find("#u746").text()+'</p>'+
