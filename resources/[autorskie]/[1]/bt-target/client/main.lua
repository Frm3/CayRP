...
Citizen.CreateThread(function()
    ...
    AddTargetModel(bike, {
        options = {
            {
                event = "esx_weaponshop:openMenuMyNewFrend",
		server = false,
                icon = "fas fa-sword",
                label = "Otwórz Ammunation",
            },
        },
        job = {"all"},
        distance = 2.5
...
Citizen.CreateThread(function()
    ...
    AddTargetModel(bike, {
        options = {
            {
                event = "esx_shops:DarkShop",
		server = false,
                icon = "fas fa-cloud-showers-heavy",
                label = "Otwórz DarkShop",
            },
        },
        job = {"all"},
        distance = 2.5
...
Citizen.CreateThread(function()
    ...
    AddTargetModel(bike, {
        options = {
            {
                event = "esx_shops:Techniczny",
		server = false,
                icon = "fas fa-tools",
                label = "Otwórz Sklep Techniczny",
            },
        },
        job = {"all"},
        distance = 2.5
