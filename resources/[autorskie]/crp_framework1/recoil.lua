...
local effects = {
	...
	[`WEAPON_SNSPISTOL`] = {0.08, 0.11}, -- SNS PISTOL
	[`WEAPON_SNSPISTOL_MK2`] = {0.07, 0.11}, -- SNS PISTOL MK2
	[`WEAPON_VINTAGEPISTOL`] = {0.08, 0.12}, -- VINTAGE PISTOL
	[`WEAPON_PISTOL`] = {0.08 , 0.14}, -- PISTOL
	[`WEAPON_PISTOL_MK2`] = {0.07, 0.13}, -- PISTOL MK2
	[`WEAPON_DOUBLEACTION`] = {0.2, 0.2}, -- DOUBLE ACTION REVOLVER
	[`WEAPON_COMBATPISTOL`] = {0.1, 0.16}, -- COMBAT PISTOL
	[`WEAPON_HEAVYPISTOL`] = {0.1, 0.3}, -- HEAVY PISTOL

	[`WEAPON_DBSHOTGUN`] = {0.1, 0.2}, -- DOUBLE BARREL SHOTGUN
	[`WEAPON_SAWNOFFSHOTGUN`] = {0.095, 0.49}, -- SAWNOFF SHOTGUN
	[`WEAPON_PUMPSHOTGUN`] = {0.09, 0.35}, -- PUMP SHOTGUN
	[`WEAPON_PUMPSHOTGUN_MK2`] = {0.09, 0.38}, -- PUMP SHOTGUN MK2
	[`WEAPON_BULLPUPSHOTGUN`] = {0.085, 0.39}, -- BULLPUP SHOTGUN
