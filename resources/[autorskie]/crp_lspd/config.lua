...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = 453.63,  y = -1015.6, z = 20.038},
			{x = 532.216,  y = -450.131, z = 30.037}
		}
	}
}
...
Config.CarDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Policyjny Garaż~s~"			-- set your desired text here
...
Config.HeliDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Heli Garaż~s~"		-- set your desired text here
...
Config.BoatDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Boat Garaż"		-- set your desired text here
...
Config.ExtraDraw3DText = "Naciśnij ~g~[E]~s~ aby otworzyć ~y~Policyjny Extra menu~s~"		-- set your desired text here

-- -- Police Cars:
Config.PoliceVehicles = {
	{ model = 'H1', label = 'S.W.A.T - Hammer', price = 5000 },
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			{x = 431.42,  y = -1015.0, z = 28.90},
			{x = 436.7,  y = -1014.96, z = 28.80}
		}
	}
}
