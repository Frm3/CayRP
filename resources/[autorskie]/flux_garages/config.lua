...
Config.MarkerSize           = {x = 3.5, y = 3.5, z = 1.0}
Config.MarkerColor          = {r = 235, g = 0, b = 0}
...
Config.Garages = {
	-- BLIP
	{
		Marker  = vector3(-1532.12, 83.88, 55.88),
		Blip	= false,
		Visible = {}
	},
	{
		Marker  = vector3(-130.28, 1006.19, 234.83),
		Blip	= false,
		Visible = {}
	},
	{
		Marker  = vector3(1551.48, 2193.62, 77.97),
		Blip	= false,
		Visible = {}
	},
	{
	...
	{
		Marker  = vector3(452.2, -976.03, 24.7),
		Blip	= false,
		Visible = {'police', 'offpolice'}
	},
}
